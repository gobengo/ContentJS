...
(function() {
  define(function(require, exports, module) {
    var SHContent, Content, jasmine;
    jasmine = require('jasmine');
    Content = require('content');
    SHContent = require('content/streamhub.content');
    
    describe('StreamHubContent', function() {
      var mockData;
      mockData = {
        "vis": 1,
        "content": {
      ...
      describe('when .registered with Content', function () {
        beforeEach(function () {
          Content.register(SHContent);
        });
        it('can be created via Content.create', function () {
          var shc = Content.create(mockData);
          expect(shc instanceof SHContent).toBe(true);
          expect(shc.html()).toBe(mockData.content.bodyHtml);
        })
      });
    });
  });
